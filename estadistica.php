...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Departamento de Planificación Estratégica Operativa'
        ...
        series: [{
           ...
           ['<?php echo $res['ano'] ?>', <?php echo $res['total'] ?> ],
            ...
            <?php
            $sql=mysql_query("SELECT ano, mes_id, total from historia where ano='2016'");
            while($res=mysql_fetch_array($sql)){
            ?>          
...
<div id="container" style="min-width: 1200px; height: 600px; margin: 0 auto"></div>
