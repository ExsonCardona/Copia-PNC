...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Incidencia Criminal Acumulada Homicidios'
        },
        xAxis: {
        ...
        series: [ {
           ...
           ['<?php echo $res['ano'] ?>', <?php echo $res['total'] ?> ],
            ...
            name: 'Homicidios 2015',
            color: 'rgba(248,161,63,1)',
            data: [
            
            <?php
            $sql=mysql_query("select ano, mes_id, total from historia where ano='2015' ");
            while($res=mysql_fetch_array($sql)){
            ?>          
           ...
           ['<?php echo $res['ano'] ?>', <?php echo $res['total'] ?> ],
            ...
            name: 'Homicidios 2017',
            color: 'rgba(186,60,61,.9)',
            data: [
            
            <?php
            $sql=mysql_query("select ano, mes_id,  sum(total) as total1 from estadistica where ano='2016' Group By
mes_id; ");
            while($res=mysql_fetch_array($sql)){
            ?>          
          ...
          <!----start-top-nav---->
           <nav class="top-nav">
            <ul class="top-nav">
                            ...
                            <li ><a href="homicidios.php">Barras</a></li>
                            <li ><a href="estadistica.php">Lineas</a></li>
...
<!--<div id="contenido">
<div id="principal">
<embed  src="PDF/com11.pdf" width="1000" height="4500">
</div>
</div>-->
